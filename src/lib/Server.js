...
var BindingForLogoutDeclarer = require('./BindingForLogoutDeclarer');

var Server = function (serverStarter, settings) {
...
Server.prototype.start = function () {
    ...
    new BindingForLogoutDeclarer().declare(this.settings.routeLogoutMessagesToVdiBinding);
};
